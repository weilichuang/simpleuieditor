	...
	public class Toolbar extends LayoutGroup
	{
		...
		private function createTextButtons() : Array
		{
			...
			return [
				...
				{ defaultIcon: new Image( atlas.getTexture( "iconfont-zoomin" )), label: "", toolTip: "缩小窗口", triggered: onZoomInButtonClick },
				{ defaultIcon: new Image( atlas.getTexture( "iconfont-zoomout" )), label: "", toolTip: "放大窗口", triggered: onZoomOutButtonClick },
		...
		private function onEnterFrame( event : starling.events.Event ) : void
		{
			...
			str += " @ " + int( UIEditorApp.instance.documentEditor.scale * 100 ) + "%";
		...
		{
			UIEditorApp.instance.currentDocumentEditor.scale /= OFFSET;
		}
		...
		{
			UIEditorApp.instance.currentDocumentEditor.scale = 1;
		}
